...
<section class="container pt-5 my-5 pb-lg-4">
	...
	<div class="col-xl-7 col-lg-6 col-md-5 order-md-2 mb-4 mb-lg-3"><img src="/assets/images/main/hero-image.jpg" alt="Hero image"></div>
	...
	<div class="col-xl-8 col-lg-10 order-3 mt-lg-n5">
		<form class="form-group d-block">
			<div class="col-xl-8__flex" style="display: flex; justify-content: space-between;">
				<input class="range-slider-value-min " style="border-radius: 5px; border: 1px solid #bbb;" placeholder="	Phone">
				<input class="range-slider-value-min " style="border-radius: 5px; border: 1px solid #bbb;" placeholder="	Email">
				<button class="btn btn-icon btn-primary px-3 w-100 w-sm-auto flex-shrink-0" type="button">Send message</button>
			</div>
...
<section class="container mb-5 mt-n3 mt-lg-0">
	...
	<div class="tns-carousel-inner row gx-4 mx-0 py-3" data-carousel-options="{&quot;items&quot;: 3, &quot;controls&quot;: false, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;500&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3}}}">
		<div class="col">
		<div class="card card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center"><img class="d-block mx-auto my-3" src="/assets/images/main/buy.svg" width="256" alt="Illustration">
			<div class="card-body">
		...
		<div class="col">
		<div class="card card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center"><img class="d-block mx-auto my-3" src="/assets/images/main/sell.svg" width="256" alt="Illustration">
			<div class="card-body">
		...
		<div class="col">
		<div class="card card-hover border-0 h-100 pb-2 pb-sm-3 px-sm-3 text-center"><img class="d-block mx-auto my-3" src="/assets/images/main/rent.svg" width="256" alt="Illustration">
			<div class="card-body">
...
<section class="container mb-5 pb-2 pb-lg-4">
	...
	<div class="col-md-5"><img class="d-block mx-md-0 mx-auto mb-md-0 mb-4" src="/assets/images/main/calculator.svg" width="416" alt="Illustration"></div>
...
<section class="container mb-5 pb-2 pb-lg-4">
	...
	<div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 6, &quot;controls&quot;: false, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:2}, &quot;500&quot;:{&quot;items&quot;:4}, &quot;992&quot;:{&quot;items&quot;:5, &quot;gutter&quot;: 16}, &quot;1200&quot;:{&quot;items&quot;:6, &quot;gutter&quot;: 24}}}">
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/01_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/01_gray.svg" alt="Logo" width="196"></a></div>
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/02_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/02_gray.svg" alt="Logo" width="196"></a></div>
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/03_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/03_gray.svg" alt="Logo" width="196"></a></div>
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/04_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/04_gray.svg" alt="Logo" width="196"></a></div>
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/05_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/05_gray.svg" alt="Logo" width="196"></a></div>
		<div><a class="swap-image" href="#"><img class="swap-to" src="/assets/images/main/06_color.svg" alt="Logo" width="196"><img class="swap-from" src="/assets/images/main/06_gray.svg" alt="Logo" width="196"></a></div>
	</div>
	</div>
</section>
...
<section class="container mb-5 pb-2 pb-lg-4">
	...
	<div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 1, &quot;mode&quot;: &quot;gallery&quot;, &quot;controlsContainer&quot;: &quot;#agents-carousel-controls&quot;, &quot;nav&quot;: false}">
		<div>
		<div class="row align-items-center">
			<div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="/assets/images/main/01.jpg" alt="Agent picture"></div>
			<div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="/assets/images/main/02.jpg" alt="Agent picture"></div>
		...
		<div>
		<div class="row align-items-center">
			<div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="/assets/images/main/02.jpg" alt="Agent picture"></div>
			<div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="/assets/images/main/03.jpg" alt="Agent picture"></div>
			<div class="col-xl-4 col-md-7 col-sm-8 px-4 px-sm-3 px-md-0 ms-md-n4 mt-n5 mt-sm-0 py-3">
			<div class="card border-0 shadow-sm ms-sm-n5">
				<blockquote class="blockquote card-body">
		...
		<div>
		<div class="row align-items-center">
			<div class="col-xl-4 d-none d-xl-block"><img class="rounded-3" src="/assets/images/main/03.jpg" alt="Agent picture"></div>
			<div class="col-xl-4 col-md-5 col-sm-4"><img class="rounded-3" src="/assets/images/main/01.jpg" alt="Agent picture"></div>
			<div class="col-xl-4 col-md-7 col-sm-8 px-4 px-sm-3 px-md-0 ms-md-n4 mt-n5 mt-sm-0 py-3">
			<div class="card border-0 shadow-sm ms-sm-n5">
				<blockquote class="blockquote card-body">
