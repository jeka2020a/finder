<?php $data = array (
  ...
  'meta_title' => 'Политика конфиденциальности интернет-магазина RD Market',
  'meta_desc' => 'Политика конфиденциальности и использования сервиса RD Market',
...
14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://rdmarket.com.ua/privacy_policy.html.</p>
  ...
  array (
    ...
    'description' => 'Политика конфиденциальности и использования сервиса RD Market',
